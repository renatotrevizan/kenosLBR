...
public class EFDUtil {
	...
	private static final String IND_APUR = "0"; 	// Mensal (IPI - RegC170)
	 ...
	 * 
	 *  Obs.: Se o registro RegC100, ou RegD100 for Cancelado, Denegado, Inutilizado, 
	 *  Emitido em Regime Especial ou de Emissão Própria, não é necessário
	 *  preencher os registros filhos. OBSERVAR EXCEÇÕES DOS REGISTROS RegC100 E D100
	 * 
	 * @param factFiscal Fato fiscal gerador do registro
	 * @param reg Registro que será gerado. Ex.: Reg0150, Reg0190...
	 * @return true/false
	 */
	public static boolean needCreateR0s(MLBRFactFiscal factFiscal, Class reg) throws Exception
	{
		...
		if(header.equals("C100"))
		{
			 ...
			 */
			if((COD_SIT.equals("08") || isNFe) && !reg.equals(Reg0150.class))
				return false;			
		}
		...
		else if(header.equals("D100"))
		{
			 ...
			 */
			if(COD_SIT.equals("08") && !reg.equals(Reg0150.class))
				return false;	
		}
	...
	public static Reg0000 createReg0000(Properties ctx, Timestamp dateFrom, Timestamp dateTo, int AD_Org_ID, String trxName) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static Reg0001 createReg0001(boolean hasInfo) throws Exception
	{
	 ...
	 * @return
	 */
	public static Reg0005 createReg0005(Properties ctx, int AD_Org_ID, String trxName) throws Exception
	{
		// 
	 ...
	 * @deprecated see {@link SPEDUtil#fillReg0100(org.adempierelbr.sped.bean.I_Reg0100, Properties, int, String)}
	 * 
	 * @param factFiscal
	 * @return
	 * @throws Exception
	 */
	public static Reg0100 createReg0100(Properties ctx, int AD_Org_ID, String trxName) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static Reg0150 createReg0150(MLBRFactFiscal factFiscal) throws Exception
	{
		...
		if(!needCreateR0s(factFiscal, Reg0150.class))
			return null;
	 ...
	 * @throws Exception
	 */
	public static Reg0190 createReg0190(MLBRFactFiscal factFiscal) throws Exception
	{
		// verificar necessidade de criar esse registro
		if(!needCreateR0s(factFiscal, Reg0190.class))
			return null;
	 ...
	 * @throws Exception
	 */
	public static Reg0190 createReg0190(MProduct product) {
	 ...
	 * @throws Exception
	 */
	public static Reg0200 createReg0200(MLBRFactFiscal factFiscal) throws Exception
	{
		// verificar necessidade de criar esse registro
		if(!needCreateR0s(factFiscal, Reg0200.class))
			return null;
	 ...
	 * @throws Exception
	 */
	public static Reg0200 createReg0200(MProduct product) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static Reg0400 createReg0400(MLBRFactFiscal factFiscal) throws Exception 
	{
	 ...
	 * @throws Exception
	 */
	public static Reg0460 createReg0460(RegC100 rc100, int COD_OBS) throws Exception 
	{
	...
	public static Reg0500 createReg0500(MElementValue ev, Timestamp dateTo) throws Exception 
	{
		//
	 ...
	 * @throws Exception
	 */
	public static Reg0990 createReg0990() throws Exception 
	{
	 ...
	 * @throws Exception
	 */
	public static RegB001 createRegB001(boolean hasInfo) throws Exception
	{
		RegB001 reg = new RegB001();
	 ...
	 * @throws Exception
	 */
	public static RegB990 createRegB990() throws Exception 
	{
		RegB990 reg = new RegB990();
	 ...
	 * @throws Exception
	 */
	public static RegC001 createRegC001(boolean hasInfo) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegC100 createRegC100(MLBRFactFiscal factFiscal) throws Exception
	{
		//
	 ...
	 * @throws Exception
	 */
	public static RegC120 createRegC120(MLBRFactFiscal factFiscal) throws Exception
	{
		...
		// valore preenchidos ao adicionar itens no RegC100
	 ...
	 * @throws Exception
	 */
	public static RegC170 createRegC170(MLBRFactFiscal factFiscal, int NUM_ITEM) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegC195 createRegC195(Reg0460 r0460) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegC990 createRegC990() throws Exception 
	{
		RegC990 reg = new RegC990();
	 ...
	 * @throws Exception
	 */
	public static RegD001 createRegD001(boolean hasInfo) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegD100 createRegD100(MLBRFactFiscal factFiscal) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegD110 createRegD110(MLBRFactFiscal factFiscal, int NUM_ITEM) throws Exception
	{
		//
	...
	public static RegD190 createRegD190(MLBRFactFiscal factFiscal, int NUM_ITEM) throws Exception
	{
		//
	 ...
	 * @throws Exception
	 */
	public static RegC500 createRegC500(MLBRFactFiscal factFiscal) throws Exception
	{
	...
	public static RegC590 createRegC590(MLBRFactFiscal factFiscal, int NUM_ITEM) throws Exception
	{
		//
	 ...
	 * @throws Exception
	 */
	public static RegD500 createRegD500(MLBRFactFiscal factFiscal) throws Exception
	{
	...
	public static RegD590 createRegD590(MLBRFactFiscal factFiscal, int NUM_ITEM) throws Exception
	{
		//
	 ...
	 * @throws Exception
	 */
	public static RegD990 createRegD990() throws Exception 
	{
		RegD990 reg = new RegD990();
	 ...
	 * @throws Exception
	 */
	public static RegH001 createRegH001(boolean hasInfo) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegK001 createRegK001(boolean hasInfo) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegH005 createRegH005(Timestamp dtInv) throws Exception 
	{
	 ...
	 * @throws Exception
	 */
	public static RegH010 createRegH010(String COD_ITEM, String UNID, BigDecimal QTD, 
	 ...
	 * @throws Exception
	 */
	public static RegK100 createRegK100(Timestamp DT_INI, Timestamp DT_FIN) throws Exception 
	{
	 ...
	 * @throws Exception
	 */
	public static RegK200 createRegK200(String COD_ITEM, String COD_PART, Timestamp DT_EST, String IND_EST, BigDecimal QTD) throws Exception 
	{
	 ...
	 * @throws Exception
	 */
	public static RegK280 createRegK280(String COD_ITEM, String COD_PART, Timestamp DT_EST, String IND_EST, BigDecimal QTD) throws Exception 
	{
	 ...
	 * @throws Exception
	 */
	public static RegK990 createRegK990() throws Exception 
	{
		RegK990 reg = new RegK990();
	 ...
	 * @throws Exception
	 */
	public static RegH990 createRegH990() throws Exception 
	{
		RegH990 reg = new RegH990();
	 ...
	 * @throws Exception
	 */
	public static RegE001 createRegE001(boolean hasInfo) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegE100 createRegE100(Timestamp dtIni, Timestamp dtFin) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegE110 createRegE110(MLBRTaxAssessment m_taxassessment) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegE111 createRegE111(String UF, boolean isICSM, X_LBR_TaxAssessmentLine line) throws Exception
	{
	...
	/**
	 * REGISTRO RegE116: OBRIGAÇÕES DO ICMS RECOLHIDO OU A RECOLHER – OPERAÇÕES PRÓPRIAS.
	 * 
	 ...
	 * @throws Exception
	 */
	public static RegE116 createRegE116(MLBRTaxAssessment m_taxAssessment) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegE200 createRegE200(String UF, Timestamp dtIni, Timestamp dtFin) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegE210 createRegE210() throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegE250 createRegE250(boolean isSameRegion, Timestamp DT_VCTO, BigDecimal VL_OR, Timestamp dateTo, String DocumentNo) throws Exception
	{
		//
		String COD_OR = "002";
		if(!isSameRegion)
	 ...
	 * @throws Exception
	 */
	public static RegE500 createRegE500(Timestamp dtIni, Timestamp dtFin) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegE510 createRegE510(RegC190 rc190) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegE520 createRegE520(MLBRTaxAssessment m_taxassessment, List<RegE510> re510s) throws Exception
	{
		...
		// crédito e débito baseado nos RegE510s
		for(RegE510 re510 : re510s)
		{
	 ...
	 * @throws Exception
	 */
	public static RegE990 createRegE990() throws Exception 
	{
		RegE990 reg = new RegE990();
	 ...
	 * @throws Exception
	 */
	public static RegG001 createRegG001(boolean hasInfo) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static RegG990 createRegG990() throws Exception 
	{
		RegG990 reg = new RegG990();
	 ...
	 * @throws Exception
	 */
	public static Reg9001 createReg9001(boolean hasInfo) throws Exception
	{
	 ...
	 * @exception Exception
	 */
	public static List<Reg9900> createReg9900() throws Exception
	{


		//
		List<Reg9900> list = new ArrayList<Reg9900>();
		...
		// totalizador do Reg9900 o +1 é pq depoisa desse registro, será criado o totalizador do 9900
		Reg9900 reg = new Reg9900();
		reg.setREG_BLC("9900");
	 ...
	 * @throws Exception
	 */
	public static Reg9990 createReg9990() throws Exception 
	{
	 ...
	 * @throws Exception
	 */
	public static Reg9999 createReg9999() throws Exception 
	{
	 ...
	 * @throws Exception
	 */
	public static Reg1001 createReg1001(boolean hasInfo) throws Exception
	{
		Reg1001 reg = new Reg1001();
		reg.setIND_MOV(hasInfo ? "0" : "1");
//		createReg1010(); //Registro Obrigatório
	 ...
	 * @throws Exception
	 */
	public static Reg1010 createReg1010(int p_C_Period_ID, String Region) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static Reg1600 createReg1600(MLBRSalesCardTotal card) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static Reg1990 createReg1990() throws Exception 
	{
