...
public abstract class NfseWebServiceServiceCallbackHandler {
    ...
    public void receiveResultsubstituirNfse(
        br.gov.sp.indaiatuba.deiss.prod.webservice.NfseWebServiceServiceStub.SubstituirNfseResponse result) {
    }
    ...
    public void receiveResultgerarNfse(
        br.gov.sp.indaiatuba.deiss.prod.webservice.NfseWebServiceServiceStub.GerarNfseResponse result) {
    }
    ...
    public void receiveResultconsultarNfsePorFaixa(
        br.gov.sp.indaiatuba.deiss.prod.webservice.NfseWebServiceServiceStub.ConsultarNfsePorFaixaResponse result) {
    }
    ...
    public void receiveResultcancelarNfse(
        br.gov.sp.indaiatuba.deiss.prod.webservice.NfseWebServiceServiceStub.CancelarNfseResponse result) {
    }
    ...
    public void receiveResultconsultarLoteRps(
        br.gov.sp.indaiatuba.deiss.prod.webservice.NfseWebServiceServiceStub.ConsultarLoteRpsResponse result) {
    }
    ...
    public void receiveResultconsultarNfseServicoPrestado(
        br.gov.sp.indaiatuba.deiss.prod.webservice.NfseWebServiceServiceStub.ConsultarNfseServicoPrestadoResponse result) {
    }
    ...
    public void receiveResultconsultarNfsePorRps(
        br.gov.sp.indaiatuba.deiss.prod.webservice.NfseWebServiceServiceStub.ConsultarNfsePorRpsResponse result) {
    }
    ...
    public void receiveResultconsultarNfseServicoTomado(
        br.gov.sp.indaiatuba.deiss.prod.webservice.NfseWebServiceServiceStub.ConsultarNfseServicoTomadoResponse result) {
    }
    ...
    public void receiveResultrecepcionarLoteRps(
        br.gov.sp.indaiatuba.deiss.prod.webservice.NfseWebServiceServiceStub.RecepcionarLoteRpsResponse result) {
    }
    ...
    public void receiveResultrecepcionarLoteRpsSincrono(
        br.gov.sp.indaiatuba.deiss.prod.webservice.NfseWebServiceServiceStub.RecepcionarLoteRpsSincronoResponse result) {
    }
